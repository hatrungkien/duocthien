...
<!-- sửa đường dẫn, hàm truy vấn cho lựa chọn tìm kiếm -->
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="from_date " class="col-sm-2 col-form-label"> <?php echo('Ngày có hiệu lực') ?><i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <input type="text" name="from_date"  value="<?php echo (!empty($start)?$start:$today); ?>" class="datepicker form-control" id="from_date"/>
                                </div>
                                <label for="to_date" class="col-sm-2 col-form-label"> <?php echo('Ngày hết hạn') ?><i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Loại tin nhắn') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-6">
                                    <button type="submit" class="btn btn-success col-sm-6 col-form-label"><?php echo display('search') ?></button>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <h4 class="col-sm-4" align="left">DANH SÁCH KHOÁ SỔ</h4>
                        <div class="col-sm-8" align="right">
                            <button class="btn-success btn">Thêm mới tin nhắn lịch hẹn</button>
                            <button class="btn-success btn">Thêm mới tin nhắn sinh nhật</button>
                            <button class="btn-success btn">Thêm mới tin nhắn quảng cáo</button>
                            <button class="btn-success btn">Xoá</button>
                        </div>
                        <br>
                        <br>
                    </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Loại tin nhắn') ?></th>
                                            <th class="text-center"><?php echo('Nội dung') ?></th>
                                            <th class="text-center"><?php echo('Đối tượng') ?></th>
                                            <th class="text-center"><?php echo('Tuổi') ?></th>
                                            <th class="text-center"><?php echo('Giới tính') ?></th>
                                            <th class="text-center"><?php echo('Ngày hiệu lực') ?></th>
                                            <th class="text-center"><?php echo('Ngày hết hiệu lực') ?></th>
