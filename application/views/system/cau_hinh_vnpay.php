            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <h4 class="col-sm-4" align="left">CẤU HÌNH VNPAY</h4>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tên quầy') ?></th>
                                            <th class="text-center"><?php echo('appID') ?></th>
                                            <th class="text-center"><?php echo('masterMeCode') ?></th>
                                            <th class="text-center"><?php echo('merchantCode') ?></th>
                                            <th class="text-center"><?php echo('merchantName') ?></th>
                                            <th class="text-center"><?php echo('merchantType') ?></th>
                                            <th class="text-center"><?php echo('terminalID') ?></th>
                                            <th class="text-center"><?php echo('customerID') ?></th>
