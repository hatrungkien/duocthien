            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <h4 class="col-sm-8" align="left">TÀI KHOẢN</h4>
                        <br>
                    </div>
...
<!-- fix this data area -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?php echo('Mã số') ?></th>
                                            <th class="text-center"><?php echo('Họ và tên') ?></th>
                                            <th class="text-center"><?php echo('Phòng ban') ?></th>
                                            <th class="text-center"><?php echo('Tài khoản') ?></th>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <h4 class="col-sm-11" align="left">CHỨC NĂNG</h4>
