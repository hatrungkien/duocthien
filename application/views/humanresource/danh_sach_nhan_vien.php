            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h4 class="col-sm-8" align="left">DANH SÁCH NGƯỜI DÙNG</h4>
                        <div class="col-sm-2">
                            <button class="col-sm-12 btn-success btn col-form-label" type="submit">Thêm mới</button>
                        </div>
                        <div class="col-sm-2">
                            <button class="col-sm-12 btn-success btn col-form-label" type="submit">Xoá người dùng</button>
                        </div>
                        <br>
                        <br>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tên cửa hàng') ?></th>
