                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="nha_thuoc" class="col-sm-2 col-form-label"> <?php echo('Loại phiếu xuất') ?><i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                      <select class="col-sm-12" name="nha-thuoc" id="nha-thuoc">
                                        <option value="Chon-tat-ca">Không theo ca</option>
                                        <option value="Nha-thuoc-Hai-Yen">Theo ca</option>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row" align="left">
                                <div class="col-sm-6" >
                                    ...
                                    <label class=""> Nhập trả lại</label>
                                </div>
                                
                                <div class="col-sm-6">
                                    <input type="checkbox" name="">
                                    <label class=""> Lấy theo ngày xuất</label>
                                </div>
