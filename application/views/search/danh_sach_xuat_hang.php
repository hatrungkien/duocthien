            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h4 class="col-sm-9" align="left">DANH SÁCH XUẤT HÀNG</h4>
                        <br>
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                ...
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Kho nhập') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                       <?php foreach($customer as $customers){?>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <button type="submit" class="btn btn-success col-form-label col-sm-12"><i class="fa fa-search-plus" aria-hidden="true"></i> <?php echo display('search') ?></button>
                                </div>                            
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tổng bán') ?></th>
                                            <th class="text-center"><?php echo('Tổng nhập') ?></th>
                                            <th class="text-center"><?php echo('Trạng thái gửi') ?></th>
