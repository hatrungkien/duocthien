            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left"></h4>
                        <div class="col-sm-6" align="right">
                            <button type="submit" class="btn btn-success col-form-label"><i class="fa fa-search-plus" aria-hidden="true"></i> <?php echo('Lấy dữ liệu') ?></button>
                        </div>
                        <br>
                        <br>
                    </div>
...
<!-- fix this data area -->
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Số lượng giao dịch trung bình/ ngày') ?></th>
                                            <th class="text-center"><?php echo('Tổng giao dịch') ?></th>
                                            <th class="text-center"><?php echo('Doanh thu trung bình trên/ đơn') ?></th>
                                            <th class="text-center"><?php echo('Tổng doanh thu') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left">BIỂU ĐỒ THỐNG KÊ</h4>
                        <div class="col-sm-6" align="right">
                            <button type="submit" class="btn btn-success col-form-label"><b>-</b></button>
                            <button type="submit" class="btn btn-success col-form-label"><b>x</b></button>
                        </div>
                        <br>
                        <br>
                    </div>
