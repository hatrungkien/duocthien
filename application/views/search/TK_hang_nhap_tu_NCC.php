...
<!-- sửa đường dẫn, hàm truy vấn cho lựa chọn tìm kiếm -->
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-3" align="left">BIỂU ĐỒ THỐNG KÊ</h4>
                        <div class="col-sm-9" align="right">
                            <label class="col-sm-2">In theo:</label>
                            <div class="col-sm-3">
                                <select name="customer_id"  class="form-control" required="">
                                    <option value=""></option>
                                       <?php foreach($customer as $customers){?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left">CHI TIẾT HÀNG NHẬP</h4>
                        <div class="col-sm-6" align="right">
                            <button type="submit" class="btn btn-success col-form-label"><?php echo('Xuất Excel') ?></button>
                            <button type="submit" class="btn btn-success col-form-label"><?php echo('Chi trả nhà cung cấp') ?></button>
                        </div>
                        <br>
                        <br>
                    </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Đơn giá VAT') ?></th>
