            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h4>TRA CỨU THEO DƯỢC</h4>
                    </div>
                    <div class="panel-body"> 
                        
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Tên dược') ?> </label>
                                <div class="col-sm-4">
                                    <input class="col-sm-12" type="text-center" name="">
                                </div>
                                <label for="customer_name" class="col-sm-2 col-form-label"><?php echo('Cửa hàng') ?> </label>
                                <div class="col-sm-4">
                        ...
                        <div class="col-sm-12" align="right">
                                ...
                                <button class="col-form-label btn btn-success">Xuất Excel</button>
                        </div>
                        <div class="col-sm-12">
                            <br>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Cơ sở') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                ...
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-10">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <input class="col-sm-12" type="text-center" name="Tìm kiếm tên dược">
                                </div>
                                <div class="col-sm-4">
                                    <select name="customer_id"  class="form-control" required="">
                                        <option value=""></option>
                                ...
                                <div class="col-sm-4">
                                    <input class="col-sm-12" type="text-center" name="Số lượng">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12" align="right">
                            <button class="col-form-label btn btn-success">Tra cứu</button>
                            <button class="col-form-label btn btn-success">Thêm</button>
                            <button class="col-form-label btn btn-success">Xuất Excel</button>
                        </div>
                        <div class="col-sm-12">
                            <br>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?php echo('Tên dược') ?></th>
                                            <th class="text-center"><?php echo('Hàm lượng') ?></th>
