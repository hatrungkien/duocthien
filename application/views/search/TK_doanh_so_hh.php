...
<!-- sửa đường dẫn, hàm truy vấn cho lựa chọn tìm kiếm -->
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left">BIỂU ĐỒ THỐNG KÊ DOANH SỐ HOA HỒNG THEO NHÂN VIÊN</h4>
                        <div class="col-sm-6" align="right">
                            <label class="col-sm-4">Thống kê theo</label>
                            <div class="col-sm-4">
                                <select name="customer_id"  class="form-control" required="">
                                    <option value=""></option>
                                       <?php foreach($customer as $customers){?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading" style="">
                        <h4 class="col-sm-6" align="left">THỐNG KÊ DOANH SỐ HOA HỒNG THEO NHÂN VIÊN</h4>
                        <div class="col-sm-6" align="right">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <!-- checkbox để tạm -->
                                            <th class="text-center"><?php echo('Cửa hàng') ?></th>
