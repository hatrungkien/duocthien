                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Quy cách') ?></th>
                                            <th class="text-center"><?php echo('Đơn vị ĐGNN') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <!-- checkbox để tạm -->
                                            <th class="text-center"><?php echo('#') ?></th>
                                            <th class="text-center"><?php echo('Ngày thay đổi') ?></th>
                                            <th class="text-center"><?php echo('Tên dược') ?></th>
                                            <th class="text-center"><?php echo('Đơn vị') ?></th>
                                            <th class="text-center"><?php echo('Giá xuất cũ') ?></th>
                                            <th class="text-center"><?php echo('Giá xuất mới') ?></th>
