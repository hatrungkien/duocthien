            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <h4 class="col-sm-10" align="left">THỐNG KÊ sỐ LƯỢNG BÁN TỪNG LOẠI THUỐC</h4>
                        <div class="col-sm-2" align="right">
                            <button type="submit" class="btn btn-success col-form-label col-sm-12">Làm mới</button>
                        </div>
                        <br>
                        <br>
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-success col-form-label col-sm-12"><?php echo display('search') ?></button>
                                </div>
                                <div class="col-sm-3"></div>
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-success col-form-label col-sm-12"><?php echo('Xuất Excel') ?></button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo('Tháng 1') ?></th>
                                            <th class="text-center"><?php echo('Tháng 2') ?></th>
                                            <th class="text-center"><?php echo('Tháng 3') ?></th>
                                            <th class="text-center"><?php echo('Tháng 4') ?></th>
                                            <th class="text-center"><?php echo('Tháng 5') ?></th>
                                            <th class="text-center"><?php echo('Tháng 6') ?></th>
                                            <th class="text-center"><?php echo('Tháng 7') ?></th>
                                            <th class="text-center"><?php echo('Tháng 8') ?></th>
                                            <th class="text-center"><?php echo('Tháng 9') ?></th>
                                            <th class="text-center"><?php echo('Tháng 10') ?></th>
                                            <th class="text-center"><?php echo('Tháng 11') ?></th>
                                            <th class="text-center"><?php echo('Tháng 12') ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2"></td>
                                            <td colspan="10" align="left"><b><?php echo('Tổng:') ?></b></td>
